    ...
    try {
      ...
      if (!user) {
        ...
        await auditService.logOperation(context, {
          ...
          oldValues: undefined,
          newValues: { userId: id, error: "user_not_found", initiatedBy: authReq.user.email }
        });
      ...
      if (!user.email || user.email.trim() === '') {
        ...
        await auditService.logOperation(context, {
          ...
          oldValues: undefined,
          newValues: { userId: id, error: "email_missing", initiatedBy: authReq.user.email }
        });
      ...
      if (process.env.AUTH_PROVIDER !== 'supabase') {
        ...
        await auditService.logOperation(context, {
          ...
          oldValues: undefined,
          newValues: { userId: id, email: user.email, error: "auth_provider_mismatch", currentProvider: process.env.AUTH_PROVIDER, initiatedBy: authReq.user.email }
        });
      ...
      try {
        ...
        if (error) {
          ...
          await auditService.logOperation(context, {
            ...
            oldValues: undefined,
            newValues: { email: user.email, error: error.message, isRateLimit, initiatedBy: authReq.user.email }
          });
        ...
        if (!data?.properties?.action_link) {
          ...
          await auditService.logOperation(context, {
            ...
            oldValues: undefined,
            newValues: { email: user.email, error: "no_action_link", initiatedBy: authReq.user.email }
          });
        ...
        try {
          ...
          await auditService.logOperation(context, {
            ...
            oldValues: undefined,
            newValues: { email: user.email, error: smtpError.message, errorType: "smtp", initiatedBy: authReq.user.email }
          });
        ...
        await auditService.logOperation(context, {
          ...
          oldValues: undefined,
          newValues: { email: user.email, error: supabaseError.message, isRateLimit, initiatedBy: authReq.user.email }
        });
      ...
      await auditService.logOperation(context, {
        ...
        oldValues: undefined,
        newValues: { email: user.email, resetLinkGenerated: true, initiatedBy: authReq.user.email }
      });
    ...
    try {
      ...
      try {
        ...
        await auditService.logOperation(context, {
          ...
          entityId: existingUser.id,
          operationType: "security_operation",
          description: `Password reset link generated and sent to ${email}${authReq.user ? ` by admin user ${authReq.user.email}` : ' via self-service'}`,
          oldValues: undefined,
          newValues: { email, resetLinkGenerated: true, initiatedBy: authReq.user?.email || 'self-service' }
        });
